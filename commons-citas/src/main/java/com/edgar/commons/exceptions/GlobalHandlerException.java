package com.edgar.commons.exceptions;

import com.edgar.commons.dto.ErrorResponse;
...
public class GlobalHandlerException {
    ...
    public ResponseEntity<ErrorResponse> handleEntidadRelacionadaException(IllegalStateException e) {
        log.warn("Error al eliminar un recurso: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(new ErrorResponse(HttpStatus.CONFLICT.value(), e.getMessage()));
    }
